...
```
cd /путь к папке hangman/
```
4. Выполните команду находясь в папке hangman:
```
bundle install
```
5. Запустите файл программы:
```
...
### **Важно!**
Новое слово (в файле **words.txt**) пишется только **БОЛЬШИМИ** буквами на **НОВОЙ** строке, это необходимо для корректной работы программы!
