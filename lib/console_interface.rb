class ConsoleInterface
  ...
  #
  # Экземпляр ConsoleInterface выводит информацию пользователю. При выводе использует
  ...
  # Метод получает массив ошибочных букв и склеивает их в строку вида "Х, У"
  def errors_to_show
    @game.errors.join(", ")
  end

  # Метод получает букву из пользовательского ввода, приводит её к верхнему
  # регистру и возвращает её
  def get_input
